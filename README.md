...
3. DO NOT EDIT ANYTHING ELSE BUT ONLY REPLACE "SERVERIP" WITH YOUR ASTERISK SERVER'S IP. If your SIP Server port is not 5160, in the file, change 5160 to the SIP Port
